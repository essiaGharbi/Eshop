...
<body>
                                    ...
                                    <div class="dropdown-item">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="Price"
                                                checked="checked" />
                                            <label class="custom-control-label c-pointer" for="Price">Price</label>
                                        </div>
                                    </div>
                                    <div class="dropdown-item">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="Quantity"
                                                checked="checked" />
                                            <label class="custom-control-label c-pointer"
                                        ...
                                        <tbody>
                                            @foreach ($products as $index => $product)
                                                <tr>
                                                    ...
                                                    <td>{{ $product->name }}</td>
                                                    <td><img src="{{ asset('uploads/' . $product->picture) }}"
                                                            width="50"></td>
                                                    <td>{{ $product->price }}</td>
                                                    ...
                                                    <td>
                                                        <a data-bs-toggle="modal"
                                                            data-bs-target="#editProd{{ $product->id }}"
                ...
                <form action="/admin/products/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="picture" class="form-control" type="file" placeholder="Picture">
                            @error('picture')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
    ...
    @foreach ($products as $index => $product)
        <div class="modal fade" id="editProd{{ $product->id }}" data-backdrop="static" data-keyboard="false"
